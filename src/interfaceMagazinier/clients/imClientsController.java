...
public class imClientsController implements Initializable {
  ...
  @FXML private TextField txt_familyname;
  @FXML private TableView<client> table_user;
  @FXML private TableColumn<client, Integer> col_id;
  @FXML private TableColumn<client, String> col_fn;
  @FXML private TableColumn<client, String> col_n;
  @FXML private TableColumn<client, Integer> numberOfSells;
  ...
  public void Add() {
    ...
    String sql = "insert into clients (firstname,familyname)values(?,?)";
    try {
